...
import { BookCoverFamily } from "@/components/book/book-cover-family"
import { ChapterList } from "@/components/book/chapter-list"
import { ArrowUpRight, BookOpen, Lock, Star, Bell } from "lucide-react"
import { chaptersFamily } from "@/lib/chapters-family"

export const metadata: Metadata = {
  title: "The Family Book",
  description:
    "EatoBiotics: The Food System Inside Your Family — a complete framework for building a healthier home food culture, supporting microbiome health across the household, and creating repeatable systems for family life.",
  openGraph: {
    title: "The Family Book — EatoBiotics",
    description: "25 chapters. A complete guide to microbiome health for the whole household. Join the waitlist.",
  },
}

export default function BookFamilyPage() {
  return (
    <>
      {/* Hero */}
            ...
            <div className="flex-1 text-center md:text-left">
              <ScrollReveal delay={100}>
                ...
                <p className="mt-2 font-serif text-xl font-medium text-muted-foreground sm:text-2xl">
                  The Food System Inside Your Family
                </p>
                <p className="mx-auto mt-6 max-w-lg text-sm leading-relaxed text-muted-foreground sm:text-base md:mx-0">
                  A practical framework for building a healthier home food culture — one that
                  supports the whole household. From microbiome science to realistic family
                  kitchen systems, each chapter builds toward a repeatable approach that works
                  for parents and children together, in real everyday life.
                </p>
        ...
        <div className="mx-auto max-w-[720px]">
          <ScrollReveal>
            ...
            <h2 className="mt-4 font-serif text-3xl font-semibold text-foreground sm:text-4xl text-balance">
              25 chapters.{" "}
              <GradientText>One complete family framework.</GradientText>
            </h2>
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              From the science of shared microbiome environments to practical kitchen systems,
              family reset plans, and real-life strategies for busy households — every chapter
              builds on the last into a complete, repeatable approach for the whole family.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={100}>
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {[
                ...
                { label: "100+", desc: "Foods, habits, and family systems referenced" },
              ].map((stat) => (
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="mx-auto max-w-[680px]">
          ...
          <ScrollReveal delay={200}>
            <ChapterList chapters={chaptersFamily} />
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[720px] text-center">
          <ScrollReveal>
            ...
            <h2 className="font-serif text-3xl font-semibold text-foreground sm:text-4xl text-balance">
              ...
              <GradientText>food system inside your family.</GradientText>
            </h2>
            <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-muted-foreground">
              Subscribe on Substack to be first in line when the family book launches in 2026
