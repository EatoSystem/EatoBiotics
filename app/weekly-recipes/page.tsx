...
const PLATES: Plate[] = [
  {
    ...
    recipes: [
      ...
      { id: 3,  name: "Protein Greens Rice Bowl",       description: "Protein with brown rice, steamed greens, cucumber, herbs, and olive oil." },
      ...
      { id: 17, name: "Protein Tomato Harvest Plate",    description: "Protein with tomatoes, greens, beans, herbs, and sourdough crumbs." },
  ...
  },
  {
    ...
    recipes: [
      ...
      { id: 36, name: "Protein Immune Support Bowl",     description: "Protein with garlic, greens, mushrooms, herbs, and root vegetables." },
  ...
  },
  {
    ...
    recipes: [
      ...
      { id: 53, name: "Protein Living Colour Bowl",         description: "Protein with raw and cooked vegetables, herbs, seeds, and fermented garnish." },
      ...
      { id: 58, name: "Protein Japanese Harmony Bowl",       description: "Protein with rice, seaweed, cucumber, greens, sesame, and miso dressing." },
