...
/**
 * Hidden founder / admin access route.
 *
 * This holds the original site-preview password form. It is reachable only via
 * the discreet "Founder Access" link on the public waitlist page (/enter) and
 * is allowed through the password gate in proxy.ts. The public no longer sees
 * a password wall — they see the waitlist landing page instead.
 */
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-6"
      ...
      <div className="w-full max-w-sm">
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground/50">
          <Link href="/enter" className="transition-colors hover:text-muted-foreground">
            ← Back to EatoBiotics
          </Link>
        </p>
      </div>
