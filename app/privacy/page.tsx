        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: "var(--foreground)" }}>
          ...
          <Section title="3. Why we collect it (legal basis)">
            ...
            <SubList items={[
              ...
              { label: "Consent", text: "For processing your health and lifestyle answers, for marketing emails, and for non-essential cookies. We ask before any assessment and record what you agreed to and when. You can withdraw consent at any time — for cookies from the footer, and for everything else by deleting your data from your account or emailing us." },
