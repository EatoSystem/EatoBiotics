...
const appMilestones: Milestone[] = [
  ...
  },
  {
    ...
    color: "#F5A623",
    detail:
      "Build the Biotics Score (daily 0-100), food logging with auto-tagging for prebiotic, probiotic, and postbiotic-supporting foods, food system trend tracking, and a searchable food profile library.",
  },
  {
    step: "03",
