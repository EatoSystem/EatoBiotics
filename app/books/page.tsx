...
export const metadata: Metadata = {
  title: "The Books — EatoBiotics",
  description:
    "Three books. One complete system. EatoBiotics explores the food system inside you, inside your family, and inside your mind — written for the way we actually live.",
  openGraph: {
    title: "The EatoBiotics Books",
    description: "Three books. One complete system for food, health, and the people you love.",
    url: "https://eatobiotics.com/books",
  },
}
