    ...
    specificFoodList: [
      {
        food: "Oats",
        biotic: "prebiotics",
        mechanism: "Beta-glucan fibre that gut microbes ferment, which is associated with steadier energy through the morning.",
      ...
      },
      {
        food: "Lentils",
        biotic: "prebiotics",
        mechanism: "A high-fibre plant protein that gives a wide range of microbes something to feed on.",
      ...
      },
      {
        ...
        biotic: "probiotics",
        mechanism: "Carries live cultures, so it adds microbial exposure rather than only feeding what is already there.",
      ...
      },
      {
        food: "Leafy greens",
        biotic: "prebiotics",
        mechanism: "Adds plant variety and polyphenols, which is associated with a more diverse microbial community.",
      ...
      },
      {
        food: "Berries",
        biotic: "prebiotics",
        mechanism: "A gentle fibre and polyphenol source that is easy to repeat day to day.",
