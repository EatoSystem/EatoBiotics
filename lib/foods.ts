...
export interface Food {
  ...
  /**
   * Path to the food's library photograph, e.g. "/food/garlic.webp".
   * Optional and additive — foods without one fall back to their emoji.
   * Generated by `scripts/generate-food-images.ts`.
   */
  image?: string
}
