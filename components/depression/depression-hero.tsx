...
export function DepressionHero() {
  return (
    <section className="relative overflow-hidden px-6 pt-32 pb-20 md:pt-40 md:pb-28">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{ background: "radial-gradient(circle, var(--icon-green), transparent 70%)", opacity: 0.07 }}
        />
        <div
      ...
      <div className="relative mx-auto max-w-[760px] text-center">
        <ScrollReveal>
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-border bg-background/80 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-muted-foreground backdrop-blur-sm">
            <Heart size={12} className="text-[var(--icon-teal)]" />
        ...
        <ScrollReveal delay={100}>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
            Depression is influenced by many biological, psychological, and environmental factors.
            One emerging area of interest is the gut-brain connection — a bidirectional system
            through which the gut microbiome may influence serotonin production, inflammation, and
            mood regulation. Food is not a treatment, but it can be one part of supporting the
            system that underpins wellbeing.
          </p>
        </ScrollReveal>
