      ...
      <div className="mx-auto max-w-[720px] text-center">
        ...
        <ScrollReveal delay={100}>
          <p className="mx-auto mt-6 max-w-md text-base leading-relaxed text-white/60">
            ...
            serotonin pathways, nourishment, and daily rhythm. In five minutes, you&apos;ll get a
            clear picture of where your system is strong — and where to start improving.
          </p>
        </ScrollReveal>
