...
const PILLARS = [
  {
    ...
    description: "How varied and colourful your plant intake is each week",
    color: "var(--icon-lime)",
  ...
  },
  {
    icon: Wheat,
    label: "Brain Fuel",
    description: "How reliably you anchor meals with protein and fibre for steady energy",
  ...
  },
  {
    icon: FlaskConical,
    label: "Live Foods",
    description: "How regularly you include fermented foods associated with mood and focus",
    color: "var(--icon-teal)",
  ...
  },
  {
    icon: Timer,
    label: "Rhythm",
    description: "How steady your meal timing, caffeine, and late-eating patterns are",
