      ...
      <div className="relative z-10 mx-auto flex max-w-[1200px] min-h-[calc(100vh-80px)] flex-col items-center justify-center gap-12 md:flex-row md:gap-16 lg:gap-20">
        ...
        <div className="flex-1 text-left max-w-[560px]">
          <ScrollReveal>
            ...
            >
              The Food System<br />Inside Your Mind
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={100}>
            <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg">
              Your gut and your brain are in constant conversation. The food you eat shapes
              your mood, focus, mental clarity, and resilience — through pathways most people
              have never been told about.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={160}>
            <p className="mt-4 text-base font-semibold" style={{ color: "var(--icon-teal)" }}>
              90–95% of serotonin is made in the gut —{" "}
              <span className="text-foreground">not the brain.</span>
            </p>
          </ScrollReveal>
