        ...
        <ScrollReveal delay={60} className="flex-1 flex items-center justify-center w-full max-w-[560px]">
          <div className="relative w-full">
            <div
              ...
              style={{ background: "radial-gradient(60% 60% at 50% 48%, rgba(76,182,72,0.20), rgba(245,197,24,0.12) 55%, transparent 78%)" }}
            />
            <Image
        ...
        <div className="flex-1 text-left max-w-[560px]">
          <ScrollReveal delay={80}>
            <h1 className="mt-5 font-serif text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl text-balance">
              ...
              <span className="brand-gradient-text">Inside Your Family</span>
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={140}>
            <p className="mt-4 max-w-md text-xl font-medium text-foreground sm:text-2xl">
              Build gut health for every person at the table.
            </p>
            <p className="mt-4 max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg">
              A practical framework any family can follow — one weekly plate, three types of food, and
              daily habits that grow with your family. Each member gets their own gut health score.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={220}>
            <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
              <Link href="/assessment-family" className="brand-gradient inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-semibold text-white shadow-lg shadow-icon-green/20 transition-all hover:shadow-xl hover:shadow-icon-green/30 hover:opacity-90">
          ...
          <ScrollReveal delay={320}>
            <div className="mt-8 flex items-center gap-6">
              {[
                ...
                { num: "Every member", label: "Gets a score" },
              ].map((s, i) => (
