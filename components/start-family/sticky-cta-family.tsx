...
export function StickyCtagFamily() {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 px-4 pb-5 pt-3 md:hidden transition-all duration-300 ${visible ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}`}
