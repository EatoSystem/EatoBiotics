...
const FOOD_SLUGS_WITH_BENEFIT = [
  { slug: "oats", benefit: "Complex carbs that support steady glucose and calm energy" },
  { slug: "yogurt", benefit: "Probiotic cultures that may support GABA-producing bacteria" },
  { slug: "blueberries", benefit: "Polyphenols that support gut diversity and reduce inflammation" },
  { slug: "kefir", benefit: "Rich in Lactobacillus strains linked to calmer stress responses" },
  { slug: "kimchi", benefit: "Fermented food that diversifies the gut microbiome" },
  { slug: "wild-salmon", benefit: "Omega-3 fats that support the brain's inflammatory balance" },
]

export function AnxietyFoods() {
        ...
        <ScrollReveal>
          <div className="mb-10">
            ...
            <h2 className="font-serif text-4xl font-semibold text-foreground sm:text-5xl text-balance">
              Foods that support a calmer system
            </h2>
            <p className="mt-4 max-w-xl text-base text-muted-foreground leading-relaxed">
              These foods support the microbial and neurological pathways most connected to the
              stress response and resilience. A starting point, not a protocol.
            </p>
          </div>
        </ScrollReveal>
