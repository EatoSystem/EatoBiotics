    ...
    <ScrollReveal>
      ...
      >
        ...
        <div className="flex-shrink-0 md:w-[280px]">
          <span
            className="font-serif text-7xl font-800 md:text-8xl"
            style={{ color }}
          >
            {number}
          </span>
          <h3 className="mt-4 font-serif text-2xl font-700 text-foreground">{label}</h3>
        ...
        <div className="flex-1">
          <h4 className="font-serif text-3xl font-700 text-foreground text-pretty">
            {heading}
          </h4>
