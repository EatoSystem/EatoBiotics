    ...
    <svg viewBox="0 0 100 130" width={180 * scale} height={234 * scale} aria-hidden>
      <defs>
        <radialGradient id="twin-aura" cx="50%" cy="42%" r="55%">
          <stop offset="0%" stopColor="rgba(168,224,99,0.28)" />
          <stop offset="60%" stopColor="rgba(45,170,110,0.10)" />
          <stop offset="100%" stopColor="rgba(11,22,7,0)" />
        </radialGradient>
        <linearGradient id="twin-body" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(253,251,247,0.16)" />
          <stop offset="100%" stopColor="rgba(253,251,247,0.05)" />
        </linearGradient>
      </defs>
      ...
      <g fill="url(#twin-body)" stroke="rgba(253,251,247,0.22)" strokeWidth="0.6">
        ...
        return (
          <g key={c.key}>
            ...
            <circle
              ...
              cy={c.node.y}
              r={on ? 2.4 : 1.4}
              fill={on ? c.color : "rgba(253,251,247,0.25)"}
              stroke={on ? "rgba(255,255,255,0.5)" : "none"}
              strokeWidth="0.4"
            />
          </g>
        )
      ...
      {/* Ground glow */}
      <ellipse cx="50" cy="102" rx="20" ry="3" fill={APP.green} opacity="0.18" />
    </svg>
  )
}
