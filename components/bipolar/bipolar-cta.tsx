      ...
      <div className="mx-auto max-w-[720px] text-center">
        <ScrollReveal>
          ...
          <h2 className="font-serif text-4xl font-semibold text-white sm:text-5xl text-balance leading-tight">
            ...
            <br />
            is supporting stability.
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={100}>
          <p className="mx-auto mt-6 max-w-md text-base leading-relaxed text-white/60">
            The Food System Assessment helps reveal whether your food habits are supporting gut diversity,
            nourishment, rhythm, and mental clarity. In a few minutes, you&apos;ll get a clearer picture
            of where your system is strong — and where you can improve.
          </p>
        </ScrollReveal>
