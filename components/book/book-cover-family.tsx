...
/**
 * Styled book cover for "EatoBiotics — The Food System Inside Your Family"
    ...
    <div className="relative mx-auto w-[260px] sm:w-[300px]">
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(160deg, #0d1f0e 0%, #132515 50%, #0a1a10 100%)" }}
        />

        {/* Warm lime wash — top-left */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 110% 70% at 15% 0%, color-mix(in srgb, var(--icon-lime) 30%, transparent) 0%, transparent 65%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, var(--icon-lime), var(--icon-green), var(--icon-teal))",
          }}
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <span
              ...
              style={{
                ...
                color: "var(--icon-lime)",
                border: "1px solid color-mix(in srgb, var(--icon-lime) 30%, transparent)",
              }}
            >
              Book 02
            </span>
          ...
          <div className="flex flex-col gap-3">
            ...
            {[...Array(5)].map((_, i) => (
              <div
                ...
                style={{
                  background: `color-mix(in srgb, var(--icon-lime) ${8 - i}%, transparent)`,
                  width: `${70 - i * 8}%`,
                }}
              />
            ))}
          ...
          <div>
            ...
            >
              ...
              <br />
              <span className="font-semibold text-white">Your Family</span>
            </p>
            <div
              className="mt-3 h-px w-12"
              style={{ background: "color-mix(in srgb, var(--icon-lime) 50%, transparent)" }}
            />
