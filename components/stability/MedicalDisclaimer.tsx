  ...
  return (
    <section className={`px-6 py-10 ${className}`} style={{ background: "#f7f7f5" }}>
      <div className="mx-auto flex max-w-3xl flex-col items-start gap-3">
        ...
        {/* Required, exact Stability disclaimer string — tests assert this copy. */}
        <p className="pl-[30px] text-xs font-medium leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
