...
/** Brand block (logo + tagline + biotic pills) — shared by the full and minimal
 *  footers. */
function BrandBlock() {
  return (
...
/** External social links + Substack — shared by the full and minimal footers. */
...
/** Minimal footer for the gated waitlist page (/enter): brand + socials + legal,
 *  with no main-site nav columns/links. */
          ...
          <div className="flex flex-wrap gap-x-14 gap-y-10">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <Link href="/method" className="text-sm text-foreground transition-colors hover:text-icon-orange">
                  How it works
                </Link>
