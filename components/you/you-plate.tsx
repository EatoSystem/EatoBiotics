...
const QUADRANTS = [
  {
    ...
    biotic: "PREBIOTIC",
    description: "Feeds your gut bacteria — the foundation of your microbiome.",
  },
  {
    ...
    biotic: "PROBIOTIC",
    description: "Delivers live cultures that diversify your gut microbiome.",
  },
  {
    ...
    biotic: "PROTEIN",
    description: "Supports gut lining repair and microbial structure.",
  },
  {
    label: "Healthy Fats",
    ...
    biotic: "POSTBIOTIC",
    description: "Reduces gut inflammation and supports microbial output.",
  },
]

export function YouPlate() {
  return (
          ...
          <div className="lg:w-[420px] lg:shrink-0">
            <ScrollReveal>
              ...
              <h2 className="mt-4 font-serif text-4xl font-semibold text-foreground sm:text-5xl text-balance">
                Build your plate,{" "}
                <span className="brand-gradient-text">one meal at a time.</span>
              </h2>
              <p className="mt-6 text-base leading-relaxed text-muted-foreground">
                The EatoBiotics Plate is your personal template for gut-healthy eating.
                Four quadrants, each targeting a different part of your microbiome —
                designed so you hit all three biotics in every meal.
              </p>
              <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                You don&apos;t need to overhaul your diet overnight. Start with one quadrant.
                Add one fermented food. Build from there — the plate does the thinking for you.
              </p>
            </ScrollReveal>
          ...
          <div className="flex-1">
            <ScrollReveal delay={100}>
              <div className="flex justify-center">
                <Image
                  ...
                  alt="The EatoBiotics Plate — four quadrants for gut-healthy eating"
                  width={500}
                  height={500}
            ...
            <ScrollReveal delay={200}>
              ...
              <p className="mt-4 text-center text-xs text-muted-foreground">
                One template. Infinite meals. Always gut-healthy.
              </p>
            </ScrollReveal>
          </div>
