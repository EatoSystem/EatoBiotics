...
import { ArrowRight, ClipboardList, BookOpen, UtensilsCrossed, Activity } from "lucide-react"
...
const STEPS = [
  {
    ...
    title: "Assess",
    description:
      "Take the free 15-question gut assessment. Get your personal gut food score across five pillars — diversity, feeding, adding, consistency, and feeling.",
    color: "var(--icon-lime)",
  ...
  },
  {
    ...
    title: "Learn",
    description:
      "Understand which biotics you're already getting and where the gaps are. Your results show you exactly which foods to add first — no guesswork required.",
  ...
  },
  {
    ...
    title: "Build",
    description:
      "Use the EatoBiotics Plate builder to design meals that hit all three biotics. One plate template. Adapted to your food preferences and your score.",
    color: "var(--icon-teal)",
  ...
  },
  {
    ...
    title: "Track",
    description:
      "Log your plate weekly. Watch your gut score improve over time. Build a food system that compounds — better habits, better health, week after week.",
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="mt-4 mx-auto max-w-lg text-base text-muted-foreground leading-relaxed">
              From your first assessment to a weekly routine you can actually stick to —
              here&apos;s how EatoBiotics works for you.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={400}>
          <div className="mt-12 text-center">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Free to start. Results sent to your inbox.
            </p>
          </div>
        </ScrollReveal>
      </div>
