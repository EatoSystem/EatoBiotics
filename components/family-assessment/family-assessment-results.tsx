    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col items-center gap-8 sm:flex-row sm:items-start sm:gap-10 lg:gap-16">
            <div className="flex shrink-0 flex-col items-center">
              <ScoreRing
                score={overall}
                color={profile.color}
                gradientId="family-assessment-ring"
        ...
        <div className="mx-auto max-w-3xl">
          <ScrollReveal>
            <h2 className="font-serif text-2xl font-semibold text-foreground sm:text-3xl">
              Your Family&rsquo;s 5 Pillars
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              How your family&rsquo;s food habits score across each of the five areas that matter most for gut health.
            </p>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <ScrollReveal>
            <h2 className="font-serif text-2xl font-semibold text-foreground sm:text-3xl">
              Your Family&rsquo;s Next 7 Days
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Three specific things you can do this week to start improving the family food system.
            </p>
          </ScrollReveal>
        ...
        <div className="mx-auto max-w-3xl">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">
              Your family&rsquo;s personalised picks
            </p>
            <h2 className="mt-2 font-serif text-2xl font-semibold text-foreground sm:text-3xl">
              Your Family Starter Pack
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Six foods matched to your family&rsquo;s profile — add any of them to this week&rsquo;s plate to start improving your score right now.
            </p>
          </ScrollReveal>
