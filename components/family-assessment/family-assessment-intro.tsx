...
const PILLARS = [
  {
    icon: Leaf,
    label: "Exposure",
    description: "How widely the family meets foods — variety and relaxed, repeated tries",
    color: "var(--icon-lime)",
  ...
  },
  {
    icon: Wheat,
    label: "Foundation",
    description: "How reliable the family's everyday whole-food defaults are",
  ...
  },
  {
    icon: Timer,
    label: "Rhythm",
    description: "How predictable, shared, and repeatable family meals are",
  ...
  },
  {
    icon: Heart,
    label: "Food Culture",
    description: "The emotional tone around food — calm, low-pressure, and shared",
