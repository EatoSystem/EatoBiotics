...
import { Camera, ArrowRight, Lock, Check, ChevronRight } from "lucide-react"
...
/* ─────────────────────────────────────────────────────────────────────────
   Component — all data hardcoded, no props required
   ───────────────────────────────────────────────────────────────────────── */
...
export function LiveDashboard(_props: LiveDashboardProps = {}) {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f2f4f0" }}>
      {/* Centred app-width column */}
      <div className="mx-auto max-w-[520px]">
        ...
        {/* ══════════════════════════════════════════════════════════════════
            3. HERO MEAL LOGGER — all three states shown for review
        ══════════════════════════════════════════════════════════════════ */}
        <div className="space-y-5 px-4 py-5">
          ...
          <div>
            <p
              className="mb-2.5 text-[9px] font-bold uppercase tracking-[0.12em]"
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <div
                  ...
                  style={{
                    background: "color-mix(in srgb, var(--icon-green) 14%, white)",
                  }}
                >
          ...
          <div>
            ...
            >
              ...
              {/* Hint lines — opacity stagger suggests animation */}
          ...
          <div>
            ...
            >
              ...
              <div
                ...
                style={{
                  background: "color-mix(in srgb, var(--icon-green) 7%, white)",
              ...
              >
                ...
                <p className="text-sm leading-relaxed" style={{ color: "var(--foreground)" }}>
                  ...
                  mood and less bloating. The banana adds inulin, a prebiotic that compounds
                  overnight. Missing: a fermented element. Adding a spoon of kefir or yoghurt
                  here would push your probiotic score from 18 to ~55.
                </p>
              </div>
              ...
              >
                <p className="text-sm leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
                  Inulin-rich foods like oats and banana feed the bacteria that produce
                  short-chain fatty acids — the compounds that signal your brain to feel
                  full and calm.
                </p>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <p
                  className="mt-1 font-serif text-2xl font-bold leading-none"
                  style={{ color }}
                >
                  {score}
                </p>
        ...
        {/* ══════════════════════════════════════════════════════════════════
            6. WEEKLY CONSULTATION — active + locked
        ══════════════════════════════════════════════════════════════════ */}
          ...
          >
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <h3
                  className="font-serif text-base font-bold leading-snug text-white"
                >
              ...
              <button
                className="mt-1 shrink-0 rounded-full px-4 py-2 text-xs font-bold text-white"
                style={{ background: "var(--icon-green)" }}
              >
                Book Sunday
              </button>
        ...
        <div className="px-4 pb-10">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "linear-gradient(to bottom, var(--icon-lime), var(--icon-green), var(--icon-teal))",
              }}
            />
            <div className="pl-3">
              <p
              ...
              <p
                ...
                style={{ color: "var(--muted-foreground)" }}
              >
                Your plant diversity has been one of your stronger areas but your Live Foods
                score is pulling down your overall Biotics number — this month, that&apos;s
                your primary focus.
              </p>
              <Link
                href="#"
